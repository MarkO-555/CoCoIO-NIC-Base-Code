...
ROM1   EQU   $6C00    BASE ADDRESS OF PSYMON ROM
ROM2   EQU   $6800    BASE ADDRESS OF EXTENSION ROM
RAM    EQU   $6380    BASE ADDRESS OF SCRATCHPAD RAM
FREE   EQU   $6000    ADDRESS OF FREE RAM
